...
from ldm.modules.diffusionmodules_quant.util import (
    checkpoint,
    conv_nd,
    linear,
    avg_pool_nd,
                ...
                if ds in attention_resolutions:
                    ...
                    layers.append(
                        AttentionBlock(
                            ...
                            ch, num_heads, dim_head, depth=transformer_depth, context_dim=context_dim, quant_config=quant_config, layer_idx=attblock_idx
                        )
                    )
                    attblock_idx += 1
